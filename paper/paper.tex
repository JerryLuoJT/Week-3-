...
\title{Week 3\thanks{Code and data are available at: LINK.}}
\usepackage{etoolbox}
\makeatletter
...
Section~\ref{sec-mydatasection} (\textbf{sec?})-
...
This graph shows that the marriage licenses are almost the same before
the pandamic, and starts to be unpredictable after 2020.
